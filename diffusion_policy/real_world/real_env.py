...
# 🔁 UR5용 RTDE 컨트롤러 대신 Lite6 컨트롤러 사용
from diffusion_policy.real_world.lite6_interpolation_controller import (
    Lite6InterpolationController,
)
...
class RealEnv:
    def __init__(
        ...
        # 🔁 Lite6 controller 사용
        robot = Lite6InterpolationController(
            shm_manager=shm_manager,
            robot_ip=robot_ip,
            frequency=125,  # xArm도 고속 루프를 돌 수 있게 유지
            lookahead_time=0.1,
            gain=300,
